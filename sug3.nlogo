...
to setup
 ...
 to turtle-setup
  ...
  set age 0
  set vision random-in-range 1 5
   set vision-points []
...
to eat-sugar
  let target one-of patches with [ not sugar-barren? ]
  if target != nobody [
    ifelse sugar > 0
      [
        set sugar sugar - 1
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <metric>sugar-barren?</metric>
    <metric>lorenz-points</metric>
    <metric>[sugar] of turtles</metric>
    <enumeratedValueSet variable="maximum-sugar-endowment">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sugar-barren?">
      <value value="10"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="max-grow-back-delay">
      <value value="19"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
